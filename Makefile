...
CCL = g++
CFLAGS = -std=c++14 -w -g
LIBSL = ./bin/*.a -lncursesw -lgpm
LIBSM = ./bin/*.a -lncursesw -lgpm
LIBSW32 = -L/usr/lib/x86_64-linux-gnu/ ./bin/*.a -lncursesw -lgpm
LIBSW64 = -L/usr/lib/x86_64-linux-gnu/ ./bin/*.a -lncursesw -lgpm
EXTL = .pe
EXTM = .mac
EXTW32 = .x32.exe
EXTW64 = .x64.exe
